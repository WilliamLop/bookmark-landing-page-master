...
const tabButtons = document.querySelectorAll(".features__link")
const clickQuestion = document.querySelectorAll('.article__question')
AOS.init();
...
tabButtons.forEach(tabButton =>{
    tabButton.addEventListener('click', (e) =>{
        ...
        if(!tabButton.classList.contains('features__link--active')){
            ...
            tabButton.classList.add('features__link--active');
        }

    });
});

clickQuestion.forEach(clickQuestion =>{
...
window.addEventListener('resize', () =>{
    const isMenuActive = document.querySelector
